class PanelApplicantsElement extends HTMLElement{
    constructor(){
        super()
        this.template = `
        <div class="container mt-3">
            <div class="row">
                <h3>Panel de Postulantes:</h3>
            </div>
            <div class="row">
                <nav class="col-12" id="regularnavbar">
                    <p>En esta sección puede ver los mensajes recibidos a través del formulario de la página realizados por lass personas interesadas en integrarse a la empresa.</p>
            ...
            <applicantslist-el></applicantslist-el>
        </div>
        `
    }
    connectedCallback(){
...
window.customElements.define('panelaplicants-el', PanelApplicantsElement)